...
export const Login: React.FC<LoginProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-zinc-950 p-4 relative overflow-hidden">
      ...
      {/* Login Card */}
      <div className="w-full max-w-md glass-panel rounded-2xl p-8 shadow-2xl z-10 border border-zinc-800">
        {/* Header Logo + Title */}
        <div className="flex flex-col items-center text-center mb-8">
          <div className="w-16 h-16 bg-zinc-900 border border-zinc-700/60 rounded-2xl flex items-center justify-center shadow-xl shadow-blue-500/10 mb-3 p-1">
          ...
          <p className="text-sm text-zinc-400 mt-1">Sign in to start your desktop proctored interview</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-11 pr-4 py-3 bg-zinc-900/80 border border-zinc-700/80 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all text-sm"
              />
            </div>
          </div>
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 cursor-pointer text-zinc-300 text-xs">
              <input
                ...
                className="w-4 h-4 rounded bg-zinc-900 border-zinc-700 text-blue-600 focus:ring-blue-500 focus:ring-offset-0"
              />
              Remember Me
            </label>
            <button
